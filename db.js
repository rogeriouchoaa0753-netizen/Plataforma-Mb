...
async function initialize() {
  const statements = [
    ...
    `ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS data_sacamento DATE`,
    `ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS sobrenome TEXT`,
    `ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS foto_perfil TEXT`,
    `ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS data_batismo DATE`,
